        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              _buildProfileIntro(context, profile.introduction),
              SizedBox(height: 10),
              _buildProfileContent(context, "지역", profile.region),
              SizedBox(height: 10),
              _buildProfileContent(context, "학력전공", profile.carrer),
              SizedBox(height: 10),
              _buildProfileContent(context, "보유자격증", profile.certification),
              SizedBox(height: 10),
              _buildProfileContent(context, "경력기간", profile.carrerYear),
              SizedBox(height: 20),
