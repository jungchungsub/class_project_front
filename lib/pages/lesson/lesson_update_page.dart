        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                _buildLessonImage(),
                ContentBox(scrollAnimate, text: "서비스제목", hintText: "서비스 제목자리입니다", lines: 1),
                ContentBox(scrollAnimate, text: "커리큘럼", hintText: "상세설명", lines: 6),
                ContentBox(scrollAnimate, text: "수강횟수", hintText: "수강 횟수를 입력하세요", lines: 1),
                ContentBox(scrollAnimate, text: "수강시간", hintText: "수강 시간을 입력하세요", lines: 1),
                ContentBox(scrollAnimate, text: "수강장소", hintText: "ex) 부산시 진구 그린아카데미", lines: 1),
